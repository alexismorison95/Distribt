...
namespace Distribt.Shared.Communication.RabbitMQ.Publishers
{
    public class RabbitMQMessagePublisher<TMessage> : IExternalMessagePublisher<TMessage> where TMessage : IMessage
    {
